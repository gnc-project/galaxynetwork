...
import (
	...
	"github.com/gnc-project/galaxynetwork/crypto/signify"
	"github.com/gnc-project/galaxynetwork/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/gnc-project/galaxynetwork/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/gnc-project/galaxynetwork/mobile")
