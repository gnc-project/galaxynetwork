...
import (
	...
	chainParams "github.com/gnc-project/galaxynetwork/params"
...
func (env *blockExecutionEnv) commitTransaction(tx *types.Transaction, coinbase common.Address) error {
	...
	receipt, err := core.ApplyTransaction(env.chain.Config(), env.chain, &coinbase, env.gasPool, env.state, env.header, tx, &env.header.GasUsed,&env.header.NetCapacity, vmconfig)
	if err != nil {
