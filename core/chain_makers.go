...
func (b *BlockGen) AddTxWithChain(bc *BlockChain, tx *types.Transaction) {
	...
	receipt, err := ApplyTransaction(b.config, bc, &b.header.Coinbase, b.gasPool, b.statedb, b.header, tx, &b.header.GasUsed,&b.header.NetCapacity, vm.Config{})
	if err != nil {
		panic(err)
	}
...
func (b *BlockGen) OffsetTime(seconds int64) {
	...
	b.header.Difficulty = b.engine.CalcDifficulty(chainreader.CurrentHeader(), b.parent.Header())
}
...
func makeHeader(chain consensus.ChainReader, parent *types.Block, state *state.StateDB, engine consensus.Engine) *types.Header {
	...
	header := &types.Header{
		...
		Difficulty: engine.CalcDifficulty(chain.CurrentHeader(), &types.Header{
