...
```shell
go get github.com/gnc-project/galaxynetwork/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/gnc-project/galaxynetwork/blob/master/params/config.go#L251).*
