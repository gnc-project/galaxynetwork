...
gnc:
	...
	@echo "Done building."
	@echo "Run \"$(GOBIN)/geth\" to launch geth."
	@./build/bin/geth --datadir=/nvme/data/geth1/ --syncmode 'full' --cache 1024 --rpc  --rpcaddr='0.0.0.0' --rpcapi='eth,web3' --rpcport=8545 --ethash.dagdir ./dag --gcmode archive --snapshot
