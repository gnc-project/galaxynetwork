...
gnc1:
	...
	@echo "Done building."
	@echo "Run \"$(GOBIN)/geth\" to launch geth."
	@./build/bin/geth --datadir=/nvme/data/geth1/ --syncmode 'full' --cache 1024 --rpc  --http.addr='0.0.0.0' --http.addr='eth,web3,net,debug' --http.addr=8545 --ethash.dagdir ./dag --gcmode archive --snapshot
